    ...
    constructor({ type, id, streamClient, members, ownCapabilities, sortParticipantsBy, clientStore, ringing = false, watching = false, }) {
        ...
        this.join = async (data) => {
            ...
            const rejoin = async ({ migrate = false } = {}) => {
                ...
                this.state.setCallingState(migrate ? exports.CallingState.MIGRATING : exports.CallingState.RECONNECTING);
                if (migrate) {
                    this.logger('debug', `[Migration]: migrating call ${this.cid} away from ${sfuServer.edge_name}`);
                    sfuClient.isMigratingAway = true;
                }
                else {
                    this.logger('debug', `[Rejoin]: Rejoining call ${this.cid} (${this.reconnectAttempts})...`);
                }
            ...
            sfuClient.signalReady.then(() => {
                ...
                sfuClient.signalWs.addEventListener('close', (e) => {
                    ...
                    if (e.code === KnownCodes.WS_CLOSED_SUCCESS)
                        return;
            ...
            try {
                ...
                this.state.setParticipants(() => {
                    ...
                    return currentParticipants.map((p) => {
                        ...
                        return reconcileParticipantLocalState(participant, existingParticipant);
                    });
                });
